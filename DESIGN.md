...
| Tier          | Purpose                                                 | Visual language                                                                                      | Where it lives                                                      |
| ------------- | ------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------- |
| **Primary**   | Contact / talk — the single most important CTA.         | Black circle, off-white text, radial-scale hover.                                                    | Hero "Let's Talk" (`header-content.astro`). Reserved.               |
| **Secondary** | Utility / download.                                     | Transparent pill, 1px black border, deep-mint underlined emphasis on partial letters ("RESU**ME**"). | Hero Resume button. Reserved.                                       |
| **Tertiary**  | Inline supporting nav (section jumps, in-flow anchors). | Uppercase label text, `underline-offset-4 hover:underline`.                                          | Hero "About Me" anchor. Use for future in-flow anchors.             |
| **Project**   | Project-card affordance only.                           | Circle with rotating textPath ring + plane orbit, 8s spin (motion-safe).                             | Every project card. Never used outside the project-card domain.     |
| **Panel**     | Peak-end closing CTA.                                   | Full Signal Mint tile, giant Thunder headline, underlined email.                                     | Contact tile at the end of the About grid. Only one Panel per page. |
